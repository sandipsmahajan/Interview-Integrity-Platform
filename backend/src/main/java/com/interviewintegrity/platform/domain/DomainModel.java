...
public final class DomainModel {
  ...
  public enum InterviewStatus { SCHEDULED, READY, LIVE, COMPLETED, CANCELLED }
  public enum SessionStatus { CREATED, AUTHENTICATED, ACTIVE, DEGRADED, ENDED }
  public enum ViolationSeverity { INFO, LOW, MEDIUM, HIGH, CRITICAL }
  public enum TelemetryType {
    HEARTBEAT, DEVICE, DISPLAY, WINDOW_FOCUS, PROCESS, NETWORK, AUDIO, VIDEO, BROWSER, CRASH
  }
