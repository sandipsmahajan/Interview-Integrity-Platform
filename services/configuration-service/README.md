...
configuration service (schema catalog, app config).
...
OpenAPI: http://localhost:8097/swagger-ui.html

## Configuration

| Key | Default | Description |
|-----|---------|-------------|
| `server.port` | 8097 | HTTP port |
| `spring.r2dbc.url` | r2dbc:postgresql://localhost:5432/configuration_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092 | Event bus |

## Database

Owned schema in `configuration_db`, managed by Flyway migrations under
