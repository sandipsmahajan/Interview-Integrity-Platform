...
organization service (tenant root, departments, teams).
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/organization_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                                    | Event bus           |

## Database

Owned schema in `organization_db`, managed by Flyway migrations under
