...
feature flag service (flags, rollouts, experiments).
...
Prerequisites: JDK 21, PostgreSQL on localhost:5432, Kafka on localhost:9092.
    ...
    ./gradlew :services:feature-flag-service:bootRun

Health: http://localhost:8094/actuator/health
OpenAPI: http://localhost:8094/swagger-ui.html
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/feature_flag_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                                    | Event bus           |

## Database

Owned schema in `feature_flag_db`, managed by Flyway migrations under
