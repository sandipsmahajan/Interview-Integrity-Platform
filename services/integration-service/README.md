...
integration service (providers, credentials, webhooks).
...
OpenAPI: http://localhost:8096/swagger-ui.html
...
| `spring.r2dbc.url` | r2dbc:postgresql://localhost:5432/integration_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092 | Event bus |

## Database

Owned schema in `integration_db`, managed by Flyway migrations under
