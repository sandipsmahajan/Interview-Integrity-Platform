...
Prerequisites: JDK 21, PostgreSQL on localhost:5432, Kafka on localhost:9092.
    ...
    ./gradlew :services:report-service:bootRun
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/report_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                              | Event bus           |

## Database

Owned schema in `report_db`, managed by Flyway migrations under
