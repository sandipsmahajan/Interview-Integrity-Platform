...
desktop client gateway (websocket session relay).
...
Prerequisites: JDK 21, PostgreSQL on localhost:5432, Kafka on localhost:9092.
    ...
    ./gradlew :services:desktop-client-service:bootRun
...
| `spring.r2dbc.url` | r2dbc:postgresql://localhost:5432/- | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092 | Event bus |

## Database

Owned schema in `-`, managed by Flyway migrations under
