# Architecture Decision Records - desktop-client-service

## ADR-0001: Service ownership

The desktop client gateway (websocket session relay) owns the domain described by its schema. All mutations go through
this service; consumers read via its REST API or subscribe to its Kafka events.

## ADR-0002: Data isolation

The service owns - exclusively. Cross-database references use soft UUID
