...
interview service (sessions, panels, feedback).
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/interview_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                                 | Event bus           |

## Database

Owned schema in `interview_db`, managed by Flyway migrations under
