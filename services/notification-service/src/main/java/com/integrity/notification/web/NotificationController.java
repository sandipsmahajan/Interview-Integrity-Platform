...
import com.integrity.notification.web.dto.CreateNotificationRequest;
import com.integrity.notification.web.dto.DeliveryOutcomeRequest;
...
public final class NotificationController {
  ...
  public Flux<NotificationResponse> list(
    ...
    if (callerId == null || !callerId.equals(userId)) {
      return Flux.error(
          new com.integrity.exception.ForbiddenException(
