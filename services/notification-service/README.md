...
notification service (channels, templates, deliveries).
...
| `spring.r2dbc.url` | r2dbc:postgresql://localhost:5432/notification_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092 | Event bus |

## Database

Owned schema in `notification_db`, managed by Flyway migrations under
