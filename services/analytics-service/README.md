...
analytics service (daily summaries, rollups).
...
OpenAPI: http://localhost:8091/swagger-ui.html
...
| `spring.r2dbc.url` | r2dbc:postgresql://localhost:5432/analytics_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092 | Event bus |

## Database

Owned schema in `analytics_db`, managed by Flyway migrations under
