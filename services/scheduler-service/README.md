...
scheduler service (jobs, executions, distributed locks).
...
Prerequisites: JDK 21, PostgreSQL on localhost:5432, Kafka on localhost:9092.
    ...
    ./gradlew :services:scheduler-service:bootRun

Health: http://localhost:8095/actuator/health
OpenAPI: http://localhost:8095/swagger-ui.html
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/scheduler_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                                 | Event bus           |

## Database

Owned schema in `scheduler_db`, managed by Flyway migrations under
