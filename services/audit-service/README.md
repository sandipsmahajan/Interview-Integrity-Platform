...
audit service (audit events, API audit log).
...
OpenAPI: http://localhost:8092/swagger-ui.html
...
| `spring.r2dbc.url`               | r2dbc:postgresql://localhost:5432/audit_db | Database connection |
| `spring.kafka.bootstrap-servers` | localhost:9092                             | Event bus           |

## Database

Owned schema in `audit_db`, managed by Flyway migrations under
