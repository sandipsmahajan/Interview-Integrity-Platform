# Architecture Decision Records - identity-service

## ADR-0001: Service ownership

The identity service (users, roles, sessions) owns the domain described by its schema. All mutations go through
this service; consumers read via its REST API or subscribe to its Kafka events.

## ADR-0002: Data isolation

The service owns identity_db exclusively. Cross-database references use soft UUID
