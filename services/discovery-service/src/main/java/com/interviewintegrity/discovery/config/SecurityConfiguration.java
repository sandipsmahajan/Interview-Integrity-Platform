...
/**
 * Configures the stateless JWT resource server security rules for the discovery service.
 *
 * <p>Registry mutation endpoints require a valid access token; the OpenAPI and actuator health
 * surfaces are public.
 */
@Configuration
