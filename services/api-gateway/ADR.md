# Architecture Decision Records - api-gateway

## ADR-0001: Service ownership

The API gateway (routing, auth, rate limiting, correlation ids) owns the domain described by its schema. All mutations go through
